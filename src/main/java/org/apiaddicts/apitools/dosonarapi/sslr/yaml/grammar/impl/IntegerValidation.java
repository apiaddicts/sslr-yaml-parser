...
public class IntegerValidation extends ValueValidation {

  @Override
  public boolean isValueValid(AstNode node, ValidationRule.Context context) {
    return node.getToken().getType() == Tokens.INTEGER;
  }
