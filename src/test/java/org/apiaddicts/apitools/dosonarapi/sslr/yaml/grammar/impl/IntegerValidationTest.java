...
public class IntegerValidationTest extends ValidationTestBase {

  @Test
  public void matches_integer_value() {
    IntegerValidation validation = new IntegerValidation();
  ...
  @Test
  public void fails_if_not_integer() {
    IntegerValidation validation = new IntegerValidation();
    ...
    assertThat(context.captured()).extracting(ValidationIssue::getMessage)
        .containsExactly("Expected: INTEGER, got: \"42.0\"");
  }
}
